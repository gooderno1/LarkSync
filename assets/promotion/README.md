...
| `create-download-task.png` | 创建 `download_only` 任务 |
| `task-card-download-only.png` | `download_only` 任务卡片 |
| `log-center-success.png` | 日志中心成功运行 |
| `conflict-management.png` | 冲突管理页面 |
| `settings-oauth-update.png` | 设置页 OAuth / 自动更新 |
| `local-markdown-output.png` | 本地 Markdown 输出目录示意 |
| `quick-start-flow.gif` | 快速开始流程动图 |
