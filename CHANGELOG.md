...
[2026-03-07] v0.5.49 fix(sync-upload): 为本地变更队列增加静默窗口，仅在文件稳定后上传，修复持续编辑导致同文档重复上云
[2026-03-07] v0.5.50-dev.1 fix(update): 自动更新 sha256 校验支持 GitHub Release 资产 digest 字段，并兼容从 Release 正文解析校验值
