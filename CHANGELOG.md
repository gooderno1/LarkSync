...
[2026-05-28] v0.7.22-dev.1 docs(promo): 补齐公开 Beta 试用入口、快速开始、安全与隐私说明、反馈排障指南、推广就绪检查清单和 GitHub Issue 表单，并同步修正 README/USAGE/版本号，降低推广前首次安装、授权和 `download_only` 首次同步的说明门槛
