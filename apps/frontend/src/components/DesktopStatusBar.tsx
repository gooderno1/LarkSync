...
export function DesktopStatusBar() {
  ...
  return (
    <footer data-desktop-statusbar="true" className="flex h-[48px] flex-none items-center justify-between border-t border-[#dce6f2] bg-white pl-9 pr-8 text-xs font-medium text-[#3f536b]">
