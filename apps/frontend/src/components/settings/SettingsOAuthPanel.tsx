      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-8 shrink-0 rounded-lg border border-[#c9d8eb] bg-white px-3 text-xs font-medium text-[#52677f] transition hover:border-[#3370FF]/40 hover:bg-[#f2f7ff] hover:text-[#2456d6]"
            onClick={toggleAdvanced}
            type="button"
          >
            {showAdvanced ? "收起配置" : "展开配置"}
          </button>
        </div>
      </div>
      ...
      {showAdvanced ? (
        <>
          ...
          <div className="mt-3 space-y-3 rounded-lg border border-[#d7e4f5] bg-[#f8fbff] p-3">
            <p className="text-xs font-medium text-[#52677f]">授权端点与存储（通常无需修改）</p>
