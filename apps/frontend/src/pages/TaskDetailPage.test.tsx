...
describe("TaskDetailPage smoke", () => {
  it("restores the original standalone detail hierarchy", () => {
    ...
    expect(html).toContain('data-sync-relationship-glyph="true"');
    expect(html).toContain('viewBox="0 0 112 56"');
    expect(html).toContain('h-[52px] w-[104px]');
    ...
    expect(html).not.toContain('/logo-horizontal.png');
