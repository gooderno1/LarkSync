...
![LarkSync 托盘菜单](../assets/promotion/tray-menu.png)

![LarkSync 仪表盘](../assets/promotion/dashboard-connected.png)

![download_only 任务配置](../assets/promotion/create-download-task.png)

![同步成功后的本地 Markdown 输出](../assets/promotion/local-markdown-output.png)

![冲突管理](../assets/promotion/conflict-management.png)

快速开始动图：

![Windows 下载与启动](../assets/promotion/windows-download-startup.gif)

![OAuth 连接流程](../assets/promotion/oauth-connect-flow.gif)

![快速开始流程](../assets/promotion/quick-start-flow.gif)
