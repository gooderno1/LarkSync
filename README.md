...
当前稳定版本：`v0.9.7`（2026-09-02）。核心运行形态为 Windows / macOS 桌面壳 + 托盘或菜单栏常驻。
当前代码基线：`v0.9.8-dev.1`。
...
- v0.9.8-dev.1 将设置页应用配置改为默认收起的统计摘要，展开后以紧凑列表提供本地改名和对应 App ID 的飞书/Lark 开发者后台“应用管理”入口；桌面双栏调整为接近等宽，默认首屏的信息密度和高度更平衡。
