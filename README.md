...
当前开发版本：`v0.8.0-dev.25`（2026-07-14）；最新稳定版：`v0.7.29`。核心运行形态正在从托盘常驻 + Web 管理面板迁移为 Windows 桌面壳 + 托盘常驻。
...
- 活动、冲突、设置和维护页在开发环境默认使用带“前端演示数据”标识的完整数据态，占满桌面工作区并覆盖典型问题、冲突、规则和更新场景；使用 `?ui-data=live` 可切换到真实后端数据，生产构建始终使用真实数据。
