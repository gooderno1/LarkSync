...
当前开发基线：`v0.8.3-dev.2`，已完成活动管理 / 问题中心 v2 产品、数据、交互、窗口切换方案及四张标准/紧凑窗口设计图；尚未修改对应业务页面与问题数据模型。
...
- v0.8.3-dev.2 将活动管理 / 问题中心 v1 图片降级为概念稿；v2 严格复用现有 228px 侧栏和 56px 顶栏，活动管理在标准窗口使用“任务 + 事件”两栏、紧凑窗口使用单主区，问题中心按现有数据与新增统一问题模型明确能力边界，并分别归档 1360×900 与 1080×720 设计稿。当前条目只完成方案与设计，不代表页面和问题状态机已经实装。
