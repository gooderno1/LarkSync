...
当前开发基线：`v0.8.3-dev.1`，已完成活动管理 / 问题中心 v1 设计图和自动更新 v2 现状审计，尚未修改对应业务页面与更新状态机。
...
- v0.8.3-dev.1 完成活动管理 / 问题中心 v1 视觉方案并纳入版本化图片记录；自动更新 v2 方案确认现有五步流程仅由下载路径、安装请求和 handoff 快照推导，规划使用统一 `UpdateOperation` 状态机、后台断点下载、自动重试、真实进度和新版本启动对账。当前条目仅为设计与开发基线，不代表功能已经实装。
